...
def main():
    ...
    for i in range(1, args.repeat_num + 1):
        ...
        # model = Re_GTN(BasicBlock1d, [1, 1, 1, 1], device=DEVICE)
        # model = DGTN_RE(BasicBlock1d, [1, 1, 1, 1], device=DEVICE)
        model.cuda()
        ...
        for epoch in range(args.epochs):
            ...
            # acc_train, loss_train, acc_val, loss_val = train(model, test_loader, optimizer, test_loader, epoch)
